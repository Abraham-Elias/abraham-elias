...
<div class="bg">
	    	<div class="row">    		
	    		<div class="col-sm-12">  
	    		 <br>  			   			
					<h2 class="title text-center">PACIENTES GENERALES NO ACTIVOS LUNES, MIERCOLES Y VIERNES</h2>    			    				    				
				</div>			 		
			</div> 
                ...
                <div class="row">  	
<div class="col-sm-9">
	    		<h2 class="title text-center">PACIENTES PROGRAMADOS DE 8:00 LUNES,MIERCOLES,VIERNES </h2>
...
<? }; ?>
 ...
 <div class="bg">
	    	<div class="row">    		
	    		<div class="col-sm-12">  
	    		 <br>  			   			
					<h2 class="title text-center">PACIENTES GENERALES DE MARTES, JUEVES Y SABADOS</h2>    			    				    				
				</div>			 		
			</div> 
                ...
                <div class="row">  	
<div class="col-sm-9">
	    		<h2 class="title text-center">PACIENTES PROGRAMADOS DE 8:00 MARTES, JUEVES, SABADOS </h2>
	    			<div class="signup-form">
...
<div class="bg">
	    	<div class="row">    		
	    		<div class="col-sm-12">  
	    		 <br>  			   			
					<h2 class="title text-center">PACIENTES GENERALES DOMINGOS</h2>    			    				    				
				</div>			 		
			</div> 
                ...
                <div class="row">  	
<div class="col-sm-9">
	    		<h2 class="title text-center">PACIENTES PROGRAMADOS DE 8:00 DOMINGOS </h2>
	    			<div class="signup-form">
