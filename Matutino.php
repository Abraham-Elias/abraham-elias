...
$consulta2="select * from pacientes WHERE Estado = 'No activo' ";
...
<section>  
    	...
    	<div class="bg">
	    	<div class="row">    		
	    		<div class="col-sm-12">  
	    		 <br>  			   			
					<h2 class="title text-center">HEMODIALISIS MATUTINO</h2>    			    				    				
				</div>			 		
			</div>    	
    		<div class="row">  	
	    		<div class="col-sm-9">
	    		<h2 class="title text-center">Registro de pacientes:</h2>
	    			<div class="signup-form">
				    	<form method="post" action="Matutino.php" enctype="multipart/form-data">
