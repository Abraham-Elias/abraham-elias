...
$consulta1="select * from pacientes WHERE Horario = 'LMV' AND Turno = '8-11' AND ESTADO = 'Urgencia' ORDER BY Maquina ASC";
$resultado1=mysqli_query($conexion, $consulta1);
$nfilas1=mysqli_num_rows($resultado1);

$consulta2="select * from pacientes WHERE Horario = 'LMV' AND Turno = '12-3' AND ESTADO = 'Urgencia' ORDER BY Maquina ASC";
$resultado2=mysqli_query($conexion, $consulta2);
$nfilas2=mysqli_num_rows($resultado2);

$consulta3="select * from pacientes WHERE Horario = 'LMV' AND Turno = '4-7' AND ESTADO = 'Urgencia' ORDER BY Maquina ASC";
$resultado3=mysqli_query($conexion, $consulta3);
$nfilas3=mysqli_num_rows($resultado3);

$consulta4="select * from pacientes WHERE Horario = 'LMV' AND Turno = 'Nocturno' AND ESTADO = 'Urgencia' ORDER BY Maquina ASC";
$resultado4=mysqli_query($conexion, $consulta4);
$nfilas4=mysqli_num_rows($resultado4);


//MARTES JUEVES Y SABADO.
$consulta5="select * from pacientes WHERE Horario = 'MJS' AND Turno = '8-11' AND ESTADO = 'Urgencia' ORDER BY Maquina ASC";
$resultado5=mysqli_query($conexion, $consulta5);
$nfilas5=mysqli_num_rows($resultado5);

$consulta6="select * from pacientes WHERE Horario = 'MJS' AND Turno = '12-3' AND ESTADO = 'Urgencia' ORDER BY Maquina ASC";
$resultado6=mysqli_query($conexion, $consulta6);
$nfilas6=mysqli_num_rows($resultado6);

$consulta7="select * from pacientes WHERE Horario = 'MJS' AND Turno = '4-7' AND ESTADO = 'Urgencia' ORDER BY Maquina ASC";
$resultado7=mysqli_query($conexion, $consulta7);
$nfilas7=mysqli_num_rows($resultado7);

$consulta8="select * from pacientes WHERE Horario = 'MJS' AND Turno = 'Nocturno' AND ESTADO = 'Urgencia' ORDER BY Maquina ASC";
$resultado8=mysqli_query($conexion, $consulta8);
$nfilas8=mysqli_num_rows($resultado8);


//DOMINGO.
$consulta9="select * from pacientes WHERE Horario = 'DOMINGO' AND Turno = '8-11' AND ESTADO = 'Urgencia' ORDER BY Maquina ASC";
$resultado9=mysqli_query($conexion, $consulta9);
$nfilas9=mysqli_num_rows($resultado9);

$consulta10="select * from pacientes WHERE Horario = 'DOMINGO' AND Turno = '12-3' AND ESTADO = 'Urgencia' ORDER BY Maquina ASC";
$resultado10=mysqli_query($conexion, $consulta10);
$nfilas10=mysqli_num_rows($resultado10);

$consulta11="select * from pacientes WHERE Horario = 'DOMINGO' AND Turno = '4-7' AND ESTADO = 'Urgencia' ORDER BY Maquina ASC";
$resultado11=mysqli_query($conexion, $consulta11);
$nfilas11=mysqli_num_rows($resultado11);

$consulta12="select * from pacientes WHERE Horario = 'DOMINGO' AND Turno = 'Nocturno' AND ESTADO = 'Urgencia' ORDER BY Maquina ASC";
...
<div class="bg">
	    	<div class="row">    		
	    		<div class="col-sm-12">  
	    		 <br>  			   			
					<h2 class="title text-center">PACIENTES GENERALES URGENCIAS EN LUNES, MIERCOLES Y VIERNES</h2>  			    				    				
				</div>			 		
			</div> 
...
<? }; ?>
 ...
 <div class="bg">
	    	<div class="row">    		
	    		<div class="col-sm-12">  
	    		 <br>  			   			
					<h2 class="title text-center">PACIENTES URGENCIAS DE MARTES, JUEVES Y SABADOS</h2>    			    				    				
				</div>			 		
			</div> 
...
<div class="bg">
	    	<div class="row">    		
	    		<div class="col-sm-12">  
	    		 <br>  			   			
					<h2 class="title text-center">PACIENTES URGENCIAS GENERALES DOMINGOS</h2>    			    				    				
				</div>			 		
			</div> 
