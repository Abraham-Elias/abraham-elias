...
<div class="col-sm-3 padding-right">
					<div class="features_items">
						...
						<div class="col-sm-6">
						<a  href="ActivoM.php?Id=<? echo $lic['Id']; ?>" class="btn btn-warning" role="button">Px Activos</a>
						</div>
						
						<div class="col-sm-6">
						<a  href="NActivoM.php?Id=<? echo $lic['Id']; ?>" class="btn btn-warning" role="button">Px No Activos</a>
						</div>
						
						<div class="col-sm-6">
						<br>
						<a  href="FallecidosM.php?Id=<? echo $lic['Id']; ?>" class="btn btn-warning" role="button">Px Fallecidos</a>
						</div>
						<div class="col-sm-6">
						<br>
						<a  href="UrgenciasM.php?Id=<? echo $lic['Id']; ?>" class="btn btn-warning" role="button">Px Urgencias</a>
						</div>
 ...
 <div class="bg">
	    	<div class="row">    		
	    		<div class="col-sm-12">  
	    		 <br>  			   			
					<h2 class="title text-center">PACIENTES NO ACTIVOS DE MARTES, JUEVES Y SABADOS</h2>    			    				    				
				</div>			 		
			</div> 
